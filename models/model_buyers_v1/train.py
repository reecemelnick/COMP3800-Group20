...
model.save("./models/model_buyers_v1/saved/buyers_probability.keras")
joblib.dump(health_habits_encoder, "./models/model_buyers_v1/saved/health_habits_encoder.pkl")
joblib.dump(gender_encoder, "./models/model_buyers_v1/saved/gender_encoder.pkl")
joblib.dump(diet_encoder, "./models/model_buyers_v1/saved/diet_encoder.pkl")
joblib.dump(health_concern_encoder, "./models/model_buyers_v1/saved/health_concern_encoder.pkl")
...
# Convert probabilities to class labels by selecting the index of the maximum probability
