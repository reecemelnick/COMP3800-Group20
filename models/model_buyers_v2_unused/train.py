...
data = pd.read_json('./models/model_buyers_v2_unused/parsed_data.json')
...
joblib.dump(health_habits_encoder, "./models/model_buyers_v2_unused/saved/health_habits_encoder.pkl")
joblib.dump(gender_encoder, "./models/model_buyers_v2_unused/saved/gender_encoder.pkl")
joblib.dump(diet_encoder, "./models/model_buyers_v2_unused/saved/diet_encoder.pkl")
joblib.dump(health_concern_encoder, "./models/model_buyers_v2_unused/saved/health_concern_encoder.pkl")
joblib.dump(economic_encoder, "./models/model_buyers_v2_unused/saved/economic_encoder.pkl")
joblib.dump(target_label_encoder, "./models/model_buyers_v2_unused/saved/target_label_encoder.pkl")
joblib.dump(scaler, "./models/model_buyers_v2_unused/saved/scaler.pkl")
